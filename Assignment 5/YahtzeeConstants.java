...
/** The min and max values for dice */
	public static final int DICE_MIN = 1;
	public static final int DICE_MAX = 6;

/** The number of tries for each user on each round */
	public static final int N_TRIES = 3;


/** Sum score categories  */
	public static final int UPPER_SCORE_SUM = 0;
	public static final int BONUS_SCORE_SUM = 1;
	public static final int LOWER_SCORE_SUM = 2;

	public static final int N_SUM_CATEGORIES = 3;
...
//public interface YahtzeeConstants {
//
//	//I've added REROLL COUNT 	
//	public static final int REROLL = 2;
//	
///** The width of the application window */
//	public static final int APPLICATION_WIDTH = 600;
//
