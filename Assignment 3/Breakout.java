...
/** Another try delay */
	...
	/*
	 * changes the direction of the ball after collision and updates the value of brick count if the collision happened. 
	 */
	...
	/*
	 * current try is over and the user can retry after a click.
	 */
	...
	/*
	 * returns the colliding object by checking up-left, up-right, down-left, and down-right points of the out rectangle of the ball.
	 */
